...
public class ReportsManager {
    ...
    public static void generateStockReport(JTable table, String admin) {
        ...
        try (PdfWriter writer = new PdfWriter(new FileOutputStream(dest)); PdfDocument pdf = new PdfDocument(writer); Document document = new Document(pdf, PageSize.A4.rotate());) {
            ...
            URL logoUrl = GUI.class.getResource("/Media/logo-dark.png");
            if (logoUrl != null) {
    ...
    public static void generateStockReportCSV(JTable table, String admin) {
        String dest = "reports/stock/csv/stock_report_"
    ...
    public static void generateReportForMonth(String month, List<ProductSupplierPair> list, String admin) {
        try {
            String filename = "reports/monthly/pdf/stock_report_" + month + "_"
            ...
            URL logoUrl = ReportsManager.class.getResource("/Media/logo-dark.png");
            if (logoUrl != null) {
            ...
            Paragraph headerParagraph = new Paragraph()
                    .add(new Text("Stock Report - " + month + "\n")
                            .setFontSize(20)
                            .setBold())
                    .add(new Text("Date: " + LocalDateTime.now().format(DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm")) + "\n")
                            .setFontSize(10))
                    .add(new Text("Generated by: " + admin)
                            .setFontSize(10))
                    .setTextAlignment(TextAlignment.RIGHT);
    ...
    public static void generateCSVReportForMonth(String month, List<ProductSupplierPair> list, String admin) {
        try {
            String filename = "reports/monthly/csv/stock_report_" + month + "_"
